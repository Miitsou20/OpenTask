...
contract Treasury is Ownable {
    ...
    event FundsWithdrawn(address indexed to, uint256 amount, uint256 remainingBalance, uint256 totalWithdrawn);
     ...
     */
    function getTransactionHistory(address account) public view returns (uint256 received, uint256 withdrawn, uint256 currentBalance) {
        return (totalReceivedByAddress[account], totalWithdrawnByAddress[account], address(this).balance);
    }
}
